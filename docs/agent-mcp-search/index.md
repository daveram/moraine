...
Codex, Claude Code, Qwen Code, Hermes, Kiro CLI, Cursor, Kimi CLI, NAC,
OpenCode, Pi, Prime Agent, and other MCP clients can find past decisions,
commands, errors, and active agent work without copying session logs by hand.
